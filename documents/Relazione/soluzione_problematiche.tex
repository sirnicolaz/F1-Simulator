...
delle ipotesi il concorrente \emph{b} avrebbe dovuto rallentare ed arrivare al checkpoint \emph{n+1} subito dopo \emph{a}. 
...
$t_{x,n+1}<t_{y,n+1}$, poich\`{e} l'ordine della coda \`{e} 
	...
	Se \emph{x} \`{e} in attesa sulla coda \emph{n+1}, vuol dire che all'iterazione precedente avr\`{a} aggiornato per
