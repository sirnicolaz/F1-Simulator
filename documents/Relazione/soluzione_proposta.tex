...
\end{description}
Non è stato necessario inserire \texbtf{Racetrack} o il suo iteratore in una risorsa protetta perchè ogni concorrente disponde della
...
\end{figure}
\end{center}
La componente \emph{Stats} è implicitamente suddivisa in 2 sottocomponenti:
\begin{itemize}
\item un computer dedicato ad ogni singolo concorrente, denominato \textbf{OnboardComputer}. Ogni concorrente ne mantiene un'istanza che utilizza
...
che colleziona le statistiche del singolo concorrente e le informazioni sulla configurazione della competizione.\\
Il \emph{Competitor} utilizza il metodo \underline{AddInfo}
\end{itemize}
\newpage
\subsubsection{Monitor}
\begin{center}
