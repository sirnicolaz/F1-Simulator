...
\end{description}
\end{itemize}
Il \textbf{Competition\_Monitor}, (come vedremo poi pi\`{u} in dettaglio è una sottocomponente di \emph{Monitor}) fa riferimento al \textbf{CompetitionComputer} per 
