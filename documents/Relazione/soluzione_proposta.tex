...
\item{Classification\_Handler}: come dice il nome, questo package è pensato per gestire la classifica.
...
\item{\textbf{procedure Get\_Lap\_Classification(Lap : INTEGER;\\ TimeInstant : FLOAT;\\ CompetitorID\_InClassific : out INTEGER\_ARRAY\_POINT;\\ 
