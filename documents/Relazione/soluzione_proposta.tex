...
\item \textbf{Strategia}, ovvero la strategia che sta adottando il pilota, suggerita dai box e dinamica nel corso della gara:
	\begin{itemize}
		...
		\item addizionalmente, quando viene fatto un pit stop, la strategia determina anche quale
		 	la quantit\`{a} di benzina da avere nel serbatoio e il tempo impiegato per il pit stop (le gomme si assume vengano
