...
public class _Competition_Monitor_RadioStub extends org.omg.CORBA.portable.ObjectImpl implements broker.radio.Competition_Monitor_Radio
{
  ...
  public void Set_Simulation_Speed (float simulationSpeed)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("Set_Simulation_Speed", true);
                $out.write_float (simulationSpeed);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  public float Get_Latest_Time_Instant ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("Get_Latest_Time_Instant", true);
                $in = _invoke ($out);
                float $result = $in.read_float ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                return Get_Latest_Time_Instant (        );
            } finally {
                _releaseReply ($in);
            }
