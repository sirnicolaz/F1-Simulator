...
package body Configurator.Skel is
      ...
      begin
         ...
         then
            ...
            begin
               ...
               --  Call Implementation
               Result_Ü :=
                 Configurator.Impl.Configure
                    (Configurator.Impl.Object'Class
                       (Self.all)'Access,
                     Argument_config_Ü);
               --  Setting the result
               CORBA.ServerRequest.Set_Result
   ...
   begin
      return (Obj.all
         in Configurator.Impl.Object'Class);
   end Servant_Is_A;
