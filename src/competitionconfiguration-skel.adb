...
package body CompetitionConfiguration.Skel is
      ...
      begin
         ...
         then
            ...
            begin
               ...
               --  Call Implementation
               Result_Ü :=
                 CompetitionConfiguration.Impl.Configure
                    (CompetitionConfiguration.Impl.Object'Class
                       (Self.all)'Access,
                     Argument_config_Ü);
               --  Setting the result
               CORBA.ServerRequest.Set_Result
   ...
   begin
      return (Obj.all
         in CompetitionConfiguration.Impl.Object'Class);
   end Servant_Is_A;
   ...
   begin
      PortableServer.Internals.Register_Skeleton
        (CompetitionConfiguration.Repository_Id,
         Servant_Is_A'Access,
         Is_A'Access,
         Invoke'Access);
   ...
   begin
      PolyORB.Initialization.Register_Module
        (PolyORB.Initialization.Module_Info'
           (Name => +"CompetitionConfiguration.Skel",
...
end CompetitionConfiguration.Skel;
