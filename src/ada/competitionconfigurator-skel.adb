...
package body CompetitionConfigurator.Skel is
      ...
      begin
         ...
         then
            ...
            begin
               ...
               --  Call Implementation
               Result_Ü :=
                 CompetitionConfigurator.Impl.Configure
                    (CompetitionConfigurator.Impl.Object'Class
                       (Self.all)'Access,
                     Argument_config_Ü);
               --  Setting the result
               CORBA.ServerRequest.Set_Result
   ...
   begin
      return (Obj.all
         in CompetitionConfigurator.Impl.Object'Class);
   end Servant_Is_A;
   ...
   begin
      PortableServer.Internals.Register_Skeleton
        (CompetitionConfigurator.Repository_Id,
         Servant_Is_A'Access,
         Is_A'Access,
         Invoke'Access);
   ...
   begin
      PolyORB.Initialization.Register_Module
        (PolyORB.Initialization.Module_Info'
           (Name => +"CompetitionConfigurator.Skel",
...
end CompetitionConfigurator.Skel;
