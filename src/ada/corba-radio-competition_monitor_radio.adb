...
with corba.radio.Competition_Monitor_Radio.Helper;

package body corba.radio.Competition_Monitor_Radio is
   ...
   begin
      ...
      Argument => CORBA.Internals.Get_Empty_Any
        (corba.radio.Competition_Monitor_Radio.Helper.TC_float_sequence),
      Arg_Modes => 0);
   ...
   is
      Argument_List_Ü : PolyORB.Any.NVList.Ref;
      Result_Ü : corba.radio.Competition_Monitor_Radio.float_sequence
        renames Returns;
      pragma Warnings (Off, Returns);
      Arg_CC_Result_Ü_Ü : aliased PolyORB.Any.Content'Class :=
        corba.radio.Competition_Monitor_Radio.Helper.Internals.Wrap
           (corba.radio.Competition_Monitor_Radio.IDL_SEQUENCE_float.Sequence
              (Result_Ü)'Unrestricted_Access);
   ...
   Get_CompetitionConfiguration_Arg_Name_circuitLength_Ü : constant PolyORB.Types.Identifier :=
     PolyORB.Types.To_PolyORB_String
        ("circuitLength");
   ...
   begin
      return ((CORBA.Is_Equivalent
        (Logical_Type_Id,
         corba.radio.Competition_Monitor_Radio.Repository_Id)
