...
package body broker.init.RegistrationHandler.Skel is
            ...
            begin
               ...
               CORBA.ServerRequest.Arguments
                 (Request,
                  Argument_List_Ü);
               --  Call Implementation
               broker.init.RegistrationHandler.Impl.Join_Competition
                 (broker.init.RegistrationHandler.Impl.Object'Class
                    (Self.all)'Access,
   ...
   begin
      return (Obj.all
         in broker.init.RegistrationHandler.Impl.Object'Class);
   end Servant_Is_A;
   ...
   begin
      PolyORB.Initialization.Register_Module
        (PolyORB.Initialization.Module_Info'
           (Name => +"broker.init.RegistrationHandler.Skel",
...
end broker.init.RegistrationHandler.Skel;
