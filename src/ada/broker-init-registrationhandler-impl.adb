...
with Broker.Init.RegistrationHandler.Skel;
pragma Warnings (Off, Broker.Init.RegistrationHandler.Skel);

use Broker.Init.RegistrationHandler;

with Common;

package body Broker.Init.RegistrationHandler.impl is
   ...
   begin
      Ada.Text_IO.Put_Line("Broker registering....");
