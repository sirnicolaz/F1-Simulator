...
package body Competition_Monitor_Radio.Skel is

   Get_CompetitorInfo_Arg_Name_lap_Ü : constant CORBA.Identifier :=
     CORBA.To_CORBA_String
        ("lap");

   Get_CompetitorInfo_Arg_Name_sector_Ü : constant CORBA.Identifier :=
     CORBA.To_CORBA_String
        ("sector");

   Get_CompetitorInfo_Arg_Name_id_Ü : constant CORBA.Identifier :=
     CORBA.To_CORBA_String
        ("id");

   Get_CompetitorInfo_Arg_Name_time_Ü : constant CORBA.Identifier :=
     CORBA.To_CORBA_String
        ("time");

   Get_CompetitionInfo_Arg_Name_timeInstant_Ü : constant CORBA.Identifier :=
     CORBA.To_CORBA_String
        ("timeInstant");

   Get_CompetitionInfo_Arg_Name_xmlInfo_Ü : constant CORBA.Identifier :=
     CORBA.To_CORBA_String
        ("xmlInfo");
   ...
   Get_CompetitionConfiguration_Arg_Name_circuitLength_Ü : constant CORBA.Identifier :=
     CORBA.To_CORBA_String
        ("circuitLength");

   Get_CompetitionConfiguration_Arg_Name_xmlConf_Ü : constant CORBA.Identifier :=
     CORBA.To_CORBA_String
        ("xmlConf");

   Get_CompetitorConfiguration_Arg_Name_id_Ü : constant CORBA.Identifier :=
     CORBA.To_CORBA_String
        ("id");
   ...
   begin
      ...
      begin
            ...
            begin
               ...
               CORBA.ServerRequest.Arguments
                 (Request,
                  Argument_List_Ü);
               --  Call Implementation
               Competition_Monitor_Radio.Impl.Get_CompetitorInfo
                 (Competition_Monitor_Radio.Impl.Object'Class
                    (Self.all)'Access,
                  Argument_lap_Ü,
                  Argument_sector_Ü,
                  Argument_id_Ü,
         ...
         then
            declare
               Argument_timeInstant_Ü : CORBA.Float;
               pragma Warnings (Off, Argument_timeInstant_Ü);
               Arg_CC_timeInstant_Ü : aliased PolyORB.Any.Content'Class :=
                 CORBA.Wrap
                    (Argument_timeInstant_Ü'Unrestricted_Access);
               Arg_Any_timeInstant_Ü : constant CORBA.Any :=
                 CORBA.Internals.Get_Wrapper_Any
                    (CORBA.TC_Float,
                     Arg_CC_timeInstant_Ü'Unchecked_Access);
               Argument_xmlInfo_Ü : CORBA.String;
               pragma Warnings (Off, Argument_xmlInfo_Ü);
               Arg_CC_xmlInfo_Ü : aliased PolyORB.Any.Content'Class :=
                 CORBA.Wrap
                    (Argument_xmlInfo_Ü'Unrestricted_Access);
               Arg_Any_xmlInfo_Ü : constant CORBA.Any :=
                 CORBA.Internals.Get_Wrapper_Any
                    (CORBA.TC_String,
                     Arg_CC_xmlInfo_Ü'Unchecked_Access);
               Result_Ü : Competition_Monitor_Radio.float_sequence;
               pragma Warnings (Off, Result_Ü);
               Arg_CC_Result_Ü_Ü : aliased PolyORB.Any.Content'Class :=
            ...
            begin
               ...
               CORBA.ServerRequest.Arguments
                 (Request,
                  Argument_List_Ü);
               --  Call Implementation
               Competition_Monitor_Radio.Impl.Get_CompetitionInfo
                 (Competition_Monitor_Radio.Impl.Object'Class
                    (Self.all)'Access,
                  Argument_timeInstant_Ü,
                  Argument_xmlInfo_Ü,
                  Result_Ü);
               --  Setting the result
               CORBA.ServerRequest.Set_Result
         ...
         then
            ...
            begin
               ...
               --  Call Implementation
               Result_Ü :=
                 Competition_Monitor_Radio.Impl.ready
                    (Competition_Monitor_Radio.Impl.Object'Class
                       (Self.all)'Access,
         ...
         then
            declare
               ...
               Argument_xmlConf_Ü : CORBA.String;
               pragma Warnings (Off, Argument_xmlConf_Ü);
               Arg_CC_xmlConf_Ü : aliased PolyORB.Any.Content'Class :=
                 CORBA.Wrap
                    (Argument_xmlConf_Ü'Unrestricted_Access);
            ...
            begin
               CORBA.NVList.Add_Item
                 (Argument_List_Ü,
                  Get_CompetitionConfiguration_Arg_Name_circuitLength_Ü,
               ...
               CORBA.ServerRequest.Arguments
                 (Request,
                  Argument_List_Ü);
               --  Call Implementation
               Competition_Monitor_Radio.Impl.Get_CompetitionConfiguration
                 (Competition_Monitor_Radio.Impl.Object'Class
                    (Self.all)'Access,
         ...
         then
            ...
            begin
               ...
               --  Call Implementation
               Result_Ü :=
                 Competition_Monitor_Radio.Impl.Get_CompetitorConfiguration
                    (Competition_Monitor_Radio.Impl.Object'Class
                       (Self.all)'Access,
                     Argument_id_Ü);
               --  Setting the result
   ...
   begin
      return (Obj.all
         in Competition_Monitor_Radio.Impl.Object'Class);
   end Servant_Is_A;
   ...
   begin
      PolyORB.Initialization.Register_Module
        (PolyORB.Initialization.Module_Info'
           (Name => +"Competition_Monitor_Radio.Skel",
...
end Competition_Monitor_Radio.Skel;
