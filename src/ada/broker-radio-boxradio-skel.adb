...
package body broker.radio.BoxRadio.Skel is

   RequestStrategy_Arg_Name_lap_Ü : constant CORBA.Identifier :=
      ...
      begin
         ...
         then
            ...
            begin
               ...
               --  Call Implementation
               Result_Ü :=
                 broker.radio.BoxRadio.Impl.RequestStrategy
                    (broker.radio.BoxRadio.Impl.Object'Class
                       (Self.all)'Access,
                     Argument_lap_Ü);
               --  Setting the result
               CORBA.ServerRequest.Set_Result
   ...
   begin
      return (Obj.all
         in broker.radio.BoxRadio.Impl.Object'Class);
   end Servant_Is_A;
   ...
   begin
      PolyORB.Initialization.Register_Module
        (PolyORB.Initialization.Module_Info'
           (Name => +"broker.radio.BoxRadio.Skel",
...
end broker.radio.BoxRadio.Skel;
