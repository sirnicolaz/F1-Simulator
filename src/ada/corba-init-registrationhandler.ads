...
package corba.init.RegistrationHandler is

   type Ref is
     new CORBA.Object.Ref with null record;

   Repository_Id : constant PolyORB.Std.String :=
     "IDL:corba/init/RegistrationHandler:1.0";
   ...
   Join_Competition_Repository_Id : constant PolyORB.Std.String :=
     "IDL:corba/init/RegistrationHandler/Join_Competition:1.0";
...
end corba.init.RegistrationHandler;
