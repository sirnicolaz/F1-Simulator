...
package body broker.init.BoxConfigurator.Skel is
      ...
      begin
         ...
         then
            ...
            begin
               ...
               --  Call Implementation
               Result_Ü :=
                 broker.init.BoxConfigurator.Impl.Configure
                    (broker.init.BoxConfigurator.Impl.Object'Class
                       (Self.all)'Access,
                     Argument_config_Ü);
               --  Setting the result
               CORBA.ServerRequest.Set_Result
   ...
   begin
      return (Obj.all
         in broker.init.BoxConfigurator.Impl.Object'Class);
   end Servant_Is_A;
   ...
   begin
      PortableServer.Internals.Register_Skeleton
        (broker.init.BoxConfigurator.Repository_Id,
         Servant_Is_A'Access,
         Is_A'Access,
         Invoke'Access);
   ...
   begin
      PolyORB.Initialization.Register_Module
        (PolyORB.Initialization.Module_Info'
           (Name => +"broker.init.BoxConfigurator.Skel",
...
end broker.init.BoxConfigurator.Skel;
