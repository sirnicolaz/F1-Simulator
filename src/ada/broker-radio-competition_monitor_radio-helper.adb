...
package body broker.radio.Competition_Monitor_Radio.Helper is
      ...
      begin
         ...
         then
            Competition_Monitor_Radio_Initialized :=
              True;
            broker.radio.Competition_Monitor_Radio.Helper.TC_Competition_Monitor_Radio :=
      ...
      begin
         ...
         then
            IDL_SEQUENCE_float_Initialized :=
              True;
            broker.radio.Competition_Monitor_Radio.Helper.TC_IDL_SEQUENCE_float :=
            ...
            IDL_SEQUENCE_float_Helper.Initialize
              (Element_TC => CORBA.TC_Float,
               Sequence_TC => broker.radio.Competition_Monitor_Radio.Helper.TC_IDL_SEQUENCE_float);
         end if;
      ...
      begin
         ...
         then
            float_sequence_Initialized :=
              True;
            broker.radio.Competition_Monitor_Radio.Helper.Internals.Initialize_IDL_SEQUENCE_float;
            broker.radio.Competition_Monitor_Radio.Helper.TC_float_sequence :=
              CORBA.TypeCode.Internals.Build_Alias_TC
                 (Name => Name_Ü,
                  Id => Id_Ü,
                  Parent => broker.radio.Competition_Monitor_Radio.Helper.TC_IDL_SEQUENCE_float);
            CORBA.TypeCode.Internals.Disable_Reference_Counting
              (broker.radio.Competition_Monitor_Radio.Helper.TC_float_sequence);
         end if;
   ...
   function Unchecked_To_Ref
     ...
     return broker.radio.Competition_Monitor_Radio.Ref
   is
      Result : broker.radio.Competition_Monitor_Radio.Ref;
   begin
      Set
        (Result,
   ...
   function From_Any
     ...
     renames broker.radio.Competition_Monitor_Radio.Helper.Internals.IDL_SEQUENCE_float_Helper.From_Any;

   function To_Any
     (Item : broker.radio.Competition_Monitor_Radio.IDL_SEQUENCE_float.Sequence)
     return CORBA.Any
     renames broker.radio.Competition_Monitor_Radio.Helper.Internals.IDL_SEQUENCE_float_Helper.To_Any;
   ...
   is
      Result : constant broker.radio.Competition_Monitor_Radio.IDL_SEQUENCE_float.Sequence :=
        broker.radio.Competition_Monitor_Radio.Helper.From_Any
           (Item);
   begin
      return broker.radio.Competition_Monitor_Radio.float_sequence
        (Result);
   ...
   is
      Result : CORBA.Any :=
        broker.radio.Competition_Monitor_Radio.Helper.To_Any
   ...
   begin
      broker.radio.Competition_Monitor_Radio.Helper.Internals.Initialize_Competition_Monitor_Radio;
      broker.radio.Competition_Monitor_Radio.Helper.Internals.Initialize_IDL_SEQUENCE_float;
      broker.radio.Competition_Monitor_Radio.Helper.Internals.Initialize_float_sequence;
   ...
   begin
      PolyORB.Initialization.Register_Module
        (PolyORB.Initialization.Module_Info'
           (Name => +"broker.radio.Competition_Monitor_Radio.Helper",
