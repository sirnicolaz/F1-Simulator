...
package body broker.radio.BoxRadio is

   RequestStrategy_Arg_Name_lap_Ü : constant PolyORB.Types.Identifier :=
     PolyORB.Types.To_PolyORB_String
        ("lap");

   RequestStrategy_Result_Name_Ü : constant PolyORB.Types.Identifier :=
     PolyORB.Types.To_PolyORB_String
        ("Result");

   ------------------------------
   -- RequestStrategy_Result_Ü --
   ------------------------------

   function RequestStrategy_Result_Ü return PolyORB.Any.NamedValue is
      pragma Inline (RequestStrategy_Result_Ü);
   begin
      return (Name => RequestStrategy_Result_Name_Ü,
      Argument => CORBA.Internals.Get_Empty_Any
        (CORBA.TC_String),
      Arg_Modes => 0);
   end RequestStrategy_Result_Ü;
   ...
   begin
      ...
      PolyORB.Any.NVList.Add_Item
        (Argument_List_Ü,
         RequestStrategy_Arg_Name_lap_Ü,
         PolyORB.Any.Any
           (Arg_Any_lap_Ü),
         PolyORB.Any.ARG_IN);
   ...
   begin
      return ((CORBA.Is_Equivalent
        (Logical_Type_Id,
         broker.radio.BoxRadio.Repository_Id)
