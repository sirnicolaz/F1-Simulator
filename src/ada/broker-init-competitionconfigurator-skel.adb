...
package body broker.init.CompetitionConfigurator.Skel is
      ...
      begin
         ...
         then
            ...
            begin
               ...
               --  Call Implementation
               Result_Ü :=
                 broker.init.CompetitionConfigurator.Impl.Configure
                    (broker.init.CompetitionConfigurator.Impl.Object'Class
                       (Self.all)'Access,
                     Argument_config_Ü);
               --  Setting the result
               CORBA.ServerRequest.Set_Result
   ...
   begin
      return (Obj.all
         in broker.init.CompetitionConfigurator.Impl.Object'Class);
   end Servant_Is_A;
   ...
   begin
      PolyORB.Initialization.Register_Module
        (PolyORB.Initialization.Module_Info'
           (Name => +"broker.init.CompetitionConfigurator.Skel",
...
end broker.init.CompetitionConfigurator.Skel;
